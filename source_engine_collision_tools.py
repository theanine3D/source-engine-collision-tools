...
class SrcEngCollProperties(bpy.types.PropertyGroup):
    ...
    Fracture_Target: bpy.props.IntProperty(
        name="Fracture Target", subtype="UNSIGNED", description="This setting is used to limit how many hulls are generated by the Generate Fractured Collision operator", soft_max=32, min=2, default=4)
    Gap_Width: bpy.props.FloatProperty(
        name="Gap Width", subtype="FACTOR", description="How wide the gaps between each hull should be after running the Generate Fractured Collision operator", soft_max=1, min=0, default=0.02)
    Voxel_Resolution: bpy.props.FloatProperty(
        name="Voxel Resolution", subtype="FACTOR", description="Used by the Generate Fractured Collision operator", soft_max=10, min=0.0001, default=0.05)
