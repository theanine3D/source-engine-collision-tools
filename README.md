...
Blender (3.0+) addon for generating and optimizing collision models for use in Source Engine. Works best when combined with the [Blender Source Tools](http://steamreview.org/BlenderSourceTools/). (Note: this addon is not affiliated with Valve Software)
