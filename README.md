...
- Source Engine has a limit of 32 hulls per collision mesh - anything higher than that can create severe lag. The "Update VMF" feature comes in handy for this. By splitting up your collision mesh into 32-hull parts, you prevent lag, and the Update VMF feature can add numerous (even dozens) of parts automatically for you to a VMF file.
